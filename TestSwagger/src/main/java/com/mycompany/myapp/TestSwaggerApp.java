...
public class TestSwaggerApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(TestSwaggerApp.class);

    private final Environment env;

    public TestSwaggerApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes TestSwagger.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TestSwaggerApp.class);
