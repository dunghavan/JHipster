...
public class HubCamApp {

    private static final Logger log = LoggerFactory.getLogger(HubCamApp.class);

    private final Environment env;

    public HubCamApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(HubCamApp.class);
