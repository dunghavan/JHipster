(function() {
    ...
    LocationMySuffixDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Location', 'Organization', 'LandingPage'];

    function LocationMySuffixDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Location, Organization, LandingPage) {
        var vm = this;
