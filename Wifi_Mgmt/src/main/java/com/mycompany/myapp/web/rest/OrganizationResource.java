...
public class OrganizationResource {
    ...
    public OrganizationResource(OrganizationRepository organizationRepository, OrganizationMapper organizationMapper, OrganizationSearchRepository organizationSearchRepository) {
    ...
    public ResponseEntity<List<OrganizationDTO>> getAllOrganizations(@ApiParam Pageable pageable) {
        ...
        return new ResponseEntity<>(organizationMapper.toDto(page.getContent()), headers, HttpStatus.OK);
    }
