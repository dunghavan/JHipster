...
public class DeviceResource {
     ...
     * Tao method moi
     */
    @PostMapping("/devices/findByUserId")
    @Timed
    public List<Device> findByUserId(@PathVariable Integer userId) throws URISyntaxException {
        log.debug("REST request to find Device by UserId: {}", userId);
            //return deviceRepository.find(userId);
            return deviceRepository.find(2);
