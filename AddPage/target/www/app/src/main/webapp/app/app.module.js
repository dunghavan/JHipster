...
var DeviceMgmtAppModule = (function () {
    function DeviceMgmtAppModule() {
    }
    return DeviceMgmtAppModule;
}());
DeviceMgmtAppModule = __decorate([
    core_1.NgModule({
        imports: [
            ...
            home_module_1.DeviceMgmtHomeModule,
            admin_module_1.DeviceMgmtAdminModule,
            account_module_1.DeviceMgmtAccountModule,
            entity_module_1.DeviceMgmtEntityModule,
        ],
        declarations: [
...
exports.DeviceMgmtAppModule = DeviceMgmtAppModule;
