...
var DeviceMgmtTestModule = (function () {
    function DeviceMgmtTestModule() {
    }
    return DeviceMgmtTestModule;
}());
DeviceMgmtTestModule = __decorate([
    core_1.NgModule({
        providers: [
...
], DeviceMgmtTestModule);
exports.DeviceMgmtTestModule = DeviceMgmtTestModule;
