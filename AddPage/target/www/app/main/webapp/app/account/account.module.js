...
var _1 = require("./");
var DeviceMgmtAccountModule = (function () {
    function DeviceMgmtAccountModule() {
    }
    DeviceMgmtAccountModule = __decorate([
        core_1.NgModule({
            imports: [
    ...
    return DeviceMgmtAccountModule;
}());
exports.DeviceMgmtAccountModule = DeviceMgmtAccountModule;
