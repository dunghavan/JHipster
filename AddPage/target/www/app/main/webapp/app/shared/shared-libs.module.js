...
var DeviceMgmtSharedLibsModule = (function () {
    function DeviceMgmtSharedLibsModule() {
    }
    DeviceMgmtSharedLibsModule = __decorate([
        core_1.NgModule({
            imports: [
    ...
    return DeviceMgmtSharedLibsModule;
}());
exports.DeviceMgmtSharedLibsModule = DeviceMgmtSharedLibsModule;
