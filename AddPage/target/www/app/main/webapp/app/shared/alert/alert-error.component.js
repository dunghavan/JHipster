...
var JhiAlertErrorComponent = (function () {
    function JhiAlertErrorComponent(alertService, eventManager, translateService) {
        ...
        this.alerts = [];
        this.cleanHttpErrorListener = eventManager.subscribe('deviceMgmtApp.httpError', function (response) {
            var i;
                ...
                case 400:
                    ...
                    if (errorHeader) {
                        ...
                        for (i = 0; i < fieldErrors.length; i++) {
                            ...
                            var fieldName = translateService.instant('deviceMgmtApp.' +
    ...
    JhiAlertErrorComponent = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof ng_jhipster_1.JhiAlertService !== "undefined" && ng_jhipster_1.JhiAlertService) === "function" && _a || Object, typeof (_b = typeof ng_jhipster_1.JhiEventManager !== "undefined" && ng_jhipster_1.JhiEventManager) === "function" && _b || Object, typeof (_c = typeof core_2.TranslateService !== "undefined" && core_2.TranslateService) === "function" && _c || Object])
