...
var _1 = require("./");
var DeviceMgmtAdminModule = (function () {
    function DeviceMgmtAdminModule() {
    }
    DeviceMgmtAdminModule = __decorate([
        core_1.NgModule({
            imports: [
    ...
    return DeviceMgmtAdminModule;
}());
exports.DeviceMgmtAdminModule = DeviceMgmtAdminModule;
